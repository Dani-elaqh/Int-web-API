...
//Create antoher root point to the root of the website
...
router.get('/get/html', function(req, res) {
    ...
    var xml = fs.readFileSync('RockingGroomers.xml', 'utf8'); //We are reading in the XML file
    var xsl = fs.readFileSync('RockingGroomers.xsl', 'utf8'); //We are reading in the XSL file
...
router.post('/post/json', function (req, res) {
    ...
    function appendJSON(obj) {
        ...
        xmlFileToJs('RockingGroomers.xml', function (err, result) {
            ...
            jsToXmlFile('RockingGroomers.xml', result, function(err){
